...
/****** Object:  Table [dbo].[Pacientes]    Script Date: 21/05/2023 18:56:06 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Pacientes](
	...
	[UF_RG] [nvarchar](15) NOT NULL,
	[Celular] [nvarchar](14) NOT NULL,
	[TelefoneFixo] [nvarchar](15) NOT NULL,
	[Email] [nvarchar](100) NOT NULL,
	[CarteirinhaDoConvenio] [nvarchar](20) NOT NULL,
...
ALTER TABLE [dbo].[Pacientes] ADD  DEFAULT (getdate()) FOR [DataDeNascimento]
GO
...
/****** Object:  Table [dbo].[Convenios]    Script Date: 21/05/2023 18:55:57 ******/
SET ANSI_NULLS ON
GO
